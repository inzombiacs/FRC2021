...
{ 
  encoderSpin.Reset();
  encoderSpin.SetDistancePerPulse(1.398/44.4);
  m_compressor.Start();
...
void Robot::TeleopPeriodic() 
{
  ...
  m_altButton6 = m_alt.GetRawButton(kAltJoystick6);
  m_altButton7 = m_alt.GetRawButton(kAltJoystick7);
  m_altButton8 = m_alt.GetRawButton(kAltJoystick8);
  m_altButton9 = m_alt.GetRawButton(kAltJoystick9);
  m_altButton10 = m_alt.GetRawButton(kAltJoystick10);
  m_altButton11 = m_alt.GetRawButton(kAltJoystick11);
  ...
  if(cReading == true && cPrevious == false)
   {
    ...
    {
      m_compressor.Stop();
      std::cout << "Compressor is oof." << std::endl << std::endl;
      cState = false;
    }
    else
    {
      m_compressor.Start();
      std::cout << "Compressor is on." << std::endl << std::endl;
      cState = true;
    }
  }
  cPrevious = cReading;
...
*/
  ...
  if (m_altButton6 == 1)
    {
//     encoderSpin.Reset();
      std::cout << encoderSpin.GetDistance() << std::endl;
    }
...
// {
//   enc_override ^= 1;
//   //Print something about the current state
// }

// if (enc_override == 0)
// {
//     //Add/subtract arc rotations
//   if (m_altButton6 == 1)
//   {
//     rot += 1;
//     m_altButton6 = 0;
...
//   else if (m_altButton7 == 1)
//   {
//     rot -= 1;
//     m_altButton7 = 0;
//   }

//   //Add/subtract full rotations
//   else if (m_altButton11 == 1)
//   {
//     rot += 8;
//     m_altButton11 = 0;
//   }

//   else if (m_altButton10 == 1)
//   {
//     rot -= 8;
//     m_altButton10 = 0;
//   }

//   //Reset rotational variable
//   else if (m_altButton8 == 1)
//   {
//     rot = 0;
//     encoderSpin.Reset();
//     m_altButton8 = 0;
...
//   if (encoderSpin.GetDistance() != rot)
//   {
//     if (encoderSpin.GetDistance() < rot)
//     {
//       m_controlArmSpinner.Set(0.5);
//     }
